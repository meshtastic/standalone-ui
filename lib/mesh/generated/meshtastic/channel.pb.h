...
typedef struct _meshtastic_ChannelSettings {
 ...
 `0` = No crypto
 `1` = The special "default" channel key: {0xd4, 0xf1, 0xbb, 0x3a, 0x20, 0x29, 0x07, 0x59, 0xf0, 0xbc, 0xff, 0xab, 0xcf, 0x4e,
 0x69, 0x01} `2` through 10 = The default channel key, except with 1 through 9 added to the last byte. Shown to user as simple1
 through 10 */
...
#define meshtastic_ChannelSettings_init_default                                                                                  \
    {                                                                                                                            \
        0, {0, {0}}, "", 0, 0, 0, false, meshtastic_ModuleSettings_init_default, 0                                               \
    }
...
#define meshtastic_ChannelSettings_init_zero                                                                                     \
    {                                                                                                                            \
        0, {0, {0}}, "", 0, 0, 0, false, meshtastic_ModuleSettings_init_zero, 0                                                  \
    }
