...
typedef struct _meshtastic_StoreAndForward_History {
 ...
 Will be sent to the client before sending the history and can be set in a subsequent request to avoid getting packets the server
...
#define _meshtastic_StoreAndForward_RequestResponse_ARRAYSIZE                                                                    \
    ((meshtastic_StoreAndForward_RequestResponse)(meshtastic_StoreAndForward_RequestResponse_CLIENT_ABORT + 1))
...
#define meshtastic_StoreAndForward_init_default                                                                                  \
    {                                                                                                                            \
        _meshtastic_StoreAndForward_RequestResponse_MIN, 0,                                                                      \
        {                                                                                                                        \
            meshtastic_StoreAndForward_Statistics_init_default                                                                   \
        }                                                                                                                        \
    }
...
#define meshtastic_StoreAndForward_init_zero                                                                                     \
    {                                                                                                                            \
        _meshtastic_StoreAndForward_RequestResponse_MIN, 0,                                                                      \
        {                                                                                                                        \
            meshtastic_StoreAndForward_Statistics_init_zero                                                                      \
        }                                                                                                                        \
    }
