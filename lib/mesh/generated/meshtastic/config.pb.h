...
typedef enum _meshtastic_Config_SecurityConfig_PacketSignaturePolicy {
 ...
 This is the default and rejects unsigned, signable broadcasts from nodes that have previously signed. */
    meshtastic_Config_SecurityConfig_PacketSignaturePolicy_PACKET_SIGNATURE_POLICY_BALANCED = 0,
    /* Accept unsigned packets for maximum compatibility while still rejecting malformed or invalid signatures. */
    meshtastic_Config_SecurityConfig_PacketSignaturePolicy_PACKET_SIGNATURE_POLICY_COMPATIBLE = 1,
...
#define _meshtastic_Config_SecurityConfig_PacketSignaturePolicy_MIN meshtastic_Config_SecurityConfig_PacketSignaturePolicy_PACKET_SIGNATURE_POLICY_BALANCED
