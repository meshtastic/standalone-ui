...
#define _meshtastic_SerialHalCommand_Type_ARRAYSIZE                                                                              \
    ((meshtastic_SerialHalCommand_Type)(meshtastic_SerialHalCommand_Type_NOOP + 1))
...
#define _meshtastic_SerialHalResponse_Result_ARRAYSIZE                                                                           \
    ((meshtastic_SerialHalResponse_Result)(meshtastic_SerialHalResponse_Result_UNSUPPORTED + 1))
...
#define meshtastic_SerialHalCommand_init_default                                                                                 \
    {                                                                                                                            \
        0, _meshtastic_SerialHalCommand_Type_MIN, 0, 0, 0,                                                                       \
        {                                                                                                                        \
            0,                                                                                                                   \
            {                                                                                                                    \
                0                                                                                                                \
...
#define meshtastic_SerialHalResponse_init_default                                                                                \
    {                                                                                                                            \
        0, _meshtastic_SerialHalResponse_Result_MIN, 0, {0, {0}}, ""                                                             \
    }
#define meshtastic_SerialHalCommand_init_zero                                                                                    \
    {                                                                                                                            \
        0, _meshtastic_SerialHalCommand_Type_MIN, 0, 0, 0,                                                                       \
        {                                                                                                                        \
            0,                                                                                                                   \
...
#define meshtastic_SerialHalResponse_init_zero                                                                                   \
    {                                                                                                                            \
        0, _meshtastic_SerialHalResponse_Result_MIN, 0, {0, {0}}, ""                                                             \
    }
