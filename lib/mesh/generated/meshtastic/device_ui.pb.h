...
#define _meshtastic_DeviceUIConfig_GpsCoordinateFormat_ARRAYSIZE                                                                 \
    ((meshtastic_DeviceUIConfig_GpsCoordinateFormat)(meshtastic_DeviceUIConfig_GpsCoordinateFormat_MLS + 1))
...
#define meshtastic_DeviceUIConfig_init_default                                                                                   \
    {                                                                                                                            \
        0, 0, 0, 0, 0, 0, _meshtastic_Theme_MIN, 0, 0, 0, _meshtastic_Language_MIN, false, meshtastic_NodeFilter_init_default,   \
            false, meshtastic_NodeHighlight_init_default, {0, {0}}, false, meshtastic_Map_init_default,                          \
...
#define meshtastic_DeviceUIConfig_init_zero                                                                                      \
    {                                                                                                                            \
        0, 0, 0, 0, 0, 0, _meshtastic_Theme_MIN, 0, 0, 0, _meshtastic_Language_MIN, false, meshtastic_NodeFilter_init_zero,      \
            false, meshtastic_NodeHighlight_init_zero, {0, {0}}, false, meshtastic_Map_init_zero, _meshtastic_CompassMode_MIN,   \
