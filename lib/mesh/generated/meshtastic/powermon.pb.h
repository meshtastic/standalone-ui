...
typedef enum _meshtastic_PowerStressMessage_Opcode {
    ...
    meshtastic_PowerStressMessage_Opcode_PRINT_INFO =
        1, /* Print board version slog and send an ack that we are alive and ready to process commands */
    meshtastic_PowerStressMessage_Opcode_FORCE_QUIET = 2, /* Try to turn off all automatic processing of packets, screen,
                                                             sleeping, etc (to make it easier to measure in isolation) */
    ...
    meshtastic_PowerStressMessage_Opcode_LED_ON =
        48, /* Turn the LED on for num_seconds (and leave it on - for baseline power measurement purposes) */
    ...
    meshtastic_PowerStressMessage_Opcode_LORA_RX =
        66, /* Receive Lora packets for num_seconds (node will be mostly just listening, unless an external agent is helping
               stress this by sending packets on the current channel) */
...
#define _meshtastic_PowerStressMessage_Opcode_ARRAYSIZE                                                                          \
    ((meshtastic_PowerStressMessage_Opcode)(meshtastic_PowerStressMessage_Opcode_GPS_ON + 1))

#define meshtastic_PowerStressMessage_cmd_ENUMTYPE meshtastic_PowerStressMessage_Opcode

/* Initializer values for message structs */
#define meshtastic_PowerMon_init_default                                                                                         \
    {                                                                                                                            \
        0                                                                                                                        \
    }
#define meshtastic_PowerStressMessage_init_default                                                                               \
    {                                                                                                                            \
        _meshtastic_PowerStressMessage_Opcode_MIN, 0                                                                             \
    }
#define meshtastic_PowerMon_init_zero                                                                                            \
    {                                                                                                                            \
        0                                                                                                                        \
    }
#define meshtastic_PowerStressMessage_init_zero                                                                                  \
    {                                                                                                                            \
        _meshtastic_PowerStressMessage_Opcode_MIN, 0                                                                             \
    }
