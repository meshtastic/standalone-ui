...
#define meshtastic_MeshBeacon_init_default                                                                                       \
    {                                                                                                                            \
        "", false, meshtastic_ChannelSettings_init_default, _meshtastic_Config_LoRaConfig_RegionCode_MIN, false,                 \
            _meshtastic_Config_LoRaConfig_ModemPreset_MIN                                                                        \
    }
#define meshtastic_MeshBeacon_init_zero                                                                                          \
    {                                                                                                                            \
        "", false, meshtastic_ChannelSettings_init_zero, _meshtastic_Config_LoRaConfig_RegionCode_MIN, false,                    \
            _meshtastic_Config_LoRaConfig_ModemPreset_MIN                                                                        \
    }
