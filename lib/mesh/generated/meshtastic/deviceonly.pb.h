...
#define meshtastic_PositionLite_init_default                                                                                     \
    {                                                                                                                            \
        0, 0, 0, 0, _meshtastic_Position_LocSource_MIN, 0                                                                        \
    }
...
#define meshtastic_NodeInfoLite_init_default                                                                                     \
    {                                                                                                                            \
        0, 0, 0, 0, false, 0, 0, 0, "", "", _meshtastic_HardwareModel_MIN, _meshtastic_Config_DeviceConfig_Role_MIN, {0, {0}}, 0 \
    }
#define meshtastic_DeviceState_init_default                                                                                      \
    {                                                                                                                            \
        false, meshtastic_MyNodeInfo_init_default, false, meshtastic_User_init_default, 0, {meshtastic_MeshPacket_init_default}, \
            false, meshtastic_MeshPacket_init_default, 0, 0, 0, false, meshtastic_MeshPacket_init_default, 0,                    \
        {                                                                                                                        \
...
#define meshtastic_NodePositionEntry_init_default                                                                                \
    {                                                                                                                            \
        0, false, meshtastic_PositionLite_init_default                                                                           \
    }
#define meshtastic_NodeTelemetryEntry_init_default                                                                               \
    {                                                                                                                            \
        0, false, meshtastic_DeviceMetrics_init_default                                                                          \
    }
#define meshtastic_NodeEnvironmentEntry_init_default                                                                             \
    {                                                                                                                            \
        0, false, meshtastic_EnvironmentMetrics_init_default                                                                     \
    }
#define meshtastic_NodeStatusEntry_init_default                                                                                  \
    {                                                                                                                            \
        0, false, meshtastic_StatusMessage_init_default                                                                          \
    }
#define meshtastic_NodeDatabase_init_default                                                                                     \
    {                                                                                                                            \
        0, {0}, {0}, {0}, {0},                                                                                                   \
        {                                                                                                                        \
            0                                                                                                                    \
...
#define meshtastic_ChannelFile_init_default                                                                                      \
    {                                                                                                                            \
        0, {meshtastic_Channel_init_default, meshtastic_Channel_init_default, meshtastic_Channel_init_default,                   \
            meshtastic_Channel_init_default, meshtastic_Channel_init_default, meshtastic_Channel_init_default,                   \
            meshtastic_Channel_init_default, meshtastic_Channel_init_default},                                                   \
            0                                                                                                                    \
    }
#define meshtastic_BackupPreferences_init_default                                                                                \
    {                                                                                                                            \
        0, 0, false, meshtastic_LocalConfig_init_default, false, meshtastic_LocalModuleConfig_init_default, false,               \
            meshtastic_ChannelFile_init_default, false, meshtastic_User_init_default                                             \
    }
...
#define meshtastic_DeviceState_init_zero                                                                                         \
    {                                                                                                                            \
        false, meshtastic_MyNodeInfo_init_zero, false, meshtastic_User_init_zero, 0, {meshtastic_MeshPacket_init_zero}, false,   \
            meshtastic_MeshPacket_init_zero, 0, 0, 0, false, meshtastic_MeshPacket_init_zero, 0,                                 \
        {                                                                                                                        \
...
#define meshtastic_NodePositionEntry_init_zero                                                                                   \
    {                                                                                                                            \
        0, false, meshtastic_PositionLite_init_zero                                                                              \
    }
#define meshtastic_NodeTelemetryEntry_init_zero                                                                                  \
    {                                                                                                                            \
        0, false, meshtastic_DeviceMetrics_init_zero                                                                             \
    }
#define meshtastic_NodeEnvironmentEntry_init_zero                                                                                \
    {                                                                                                                            \
        0, false, meshtastic_EnvironmentMetrics_init_zero                                                                        \
    }
#define meshtastic_NodeStatusEntry_init_zero                                                                                     \
    {                                                                                                                            \
        0, false, meshtastic_StatusMessage_init_zero                                                                             \
    }
#define meshtastic_NodeDatabase_init_zero                                                                                        \
    {                                                                                                                            \
        0, {0}, {0}, {0}, {0},                                                                                                   \
        {                                                                                                                        \
            0                                                                                                                    \
...
#define meshtastic_ChannelFile_init_zero                                                                                         \
    {                                                                                                                            \
        0, {meshtastic_Channel_init_zero, meshtastic_Channel_init_zero, meshtastic_Channel_init_zero,                            \
            meshtastic_Channel_init_zero, meshtastic_Channel_init_zero, meshtastic_Channel_init_zero,                            \
            meshtastic_Channel_init_zero, meshtastic_Channel_init_zero},                                                         \
            0                                                                                                                    \
    }
#define meshtastic_BackupPreferences_init_zero                                                                                   \
    {                                                                                                                            \
        0, 0, false, meshtastic_LocalConfig_init_zero, false, meshtastic_LocalModuleConfig_init_zero, false,                     \
            meshtastic_ChannelFile_init_zero, false, meshtastic_User_init_zero                                                   \
    }
